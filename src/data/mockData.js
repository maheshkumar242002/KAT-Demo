...
export const coaches = [
  ...
  },
  {
    ...
    email: "marcus.a@kat-academy.com",
    status: "Active",
...
export const products = [
  {
    ...
    rating: 4.8,
    reviews: 142,
    image: "https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=300&h=300&fit=crop&q=80",
    category: "Almonds",
    discountBadge: "10% OFF",
    originalPrice: 16.99,
    stock: 45,
    description: "Premium grade California Almonds. Handpicked, raw, and high in dietary fiber, protein, and essential healthy fats."
  },
  {
    id: "p2",
    ...
    rating: 4.9,
    reviews: 84,
    image: "https://images.unsplash.com/photo-1534080391025-a77d018f64e4?w=300&h=300&fit=crop&q=80",
    category: "Pistachios",
    discountBadge: "Best Seller",
    originalPrice: 22.00,
    stock: 12,
    description: "Roasted Iranian pistachios, lightly salted. Naturally opened shells, crunchier bite, and packed with vitamins."
  },
  {
    id: "p3",
    name: "Whole Cashew Nuts (Jumbo Kaju)",
    price: 16.50,
    rating: 4.7,
    reviews: 210,
    ...
    originalPrice: 16.50,
    stock: 28,
    description: "Jumbo size, whole raw cashew nuts. Rich in flavor, creamy texture, perfect for healthy snacking or baking."
  },
  {
    id: "p4",
    name: "Chilean Walnut Halves (Akhrot)",
    price: 19.99,
    rating: 4.8,
    reviews: 95,
    image: "https://images.unsplash.com/photo-1585238342024-78d387f4a707?w=300&h=300&fit=crop&q=80",
    category: "Walnuts",
    discountBadge: "Omega-3",
    originalPrice: 24.99,
    stock: 110,
    description: "High-quality Chilean walnut kernels without shells. Vacuum packed to retain freshness and natural oils."
  },
  {
    id: "p5",
    ...
    rating: 4.6,
    reviews: 62,
    image: "https://images.unsplash.com/photo-1606757389105-6482977a4128?w=300&h=300&fit=crop&q=80",
    category: "Raisins",
    discountBadge: "Sweet",
    originalPrice: 12.00,
    stock: 24,
    description: "Naturally sweet, sun-dried golden raisins. Packed with energy and antioxidants, perfect for adding to oatmeal or salads."
  },
  {
    id: "p6",
    ...
    rating: 4.9,
    reviews: 47,
    image: "https://images.unsplash.com/photo-1538340739991-de29f8a54057?w=300&h=300&fit=crop&q=80",
    category: "Assorted",
    discountBadge: "Hot Deal",
    originalPrice: 35.00,
    stock: 64,
    description: "Curated premium assortments of premium badam, pista, kaju, akhrot, and golden raisins in a reusable zip lock bag."
  }
];
...
export const orders = [
  {
    ...
    date: daysAgo(1),
    items: [
      { id: "p1", name: "California Almonds (Premium Badam)", quantity: 2, price: 14.99 }
    ],
    total: 29.98,
    status: "Processing"
  },
  {
    ...
    date: daysAgo(3),
    items: [
      { id: "p3", name: "Whole Cashew Nuts (Jumbo Kaju)", quantity: 1, price: 16.50 },
      { id: "p4", name: "Chilean Walnut Halves (Akhrot)", quantity: 2, price: 19.99 }
    ],
    total: 56.48,
    status: "Shipped"
  },
  {
    ...
    date: daysAgo(6),
    items: [
      { id: "p2", name: "Salted Roasted Pistachios (Pista)", quantity: 1, price: 18.99 },
      { id: "p5", name: "Golden Raisins (Kishmish)", quantity: 1, price: 9.99 }
    ],
    total: 28.98,
    status: "Delivered"
  },
  {
    ...
    date: daysAgo(10),
    items: [
      { id: "p6", name: "Exotic Mixed Dry Fruits Pack", quantity: 1, price: 29.99 }
    ],
    total: 29.99,
    status: "Delivered"
  }
